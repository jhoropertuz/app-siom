(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["paginasInternas-entrega-oxigem-entrega-oxigem-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPaginasInternasEntregaOxigemEntregaOxigemPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPaginasInternasEntregaOxigemEntregaOxigemRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EntregaOxigemPageRoutingModule", function () {
        return EntregaOxigemPageRoutingModule;
      });
      /* harmony import */
      ...
      var _entrega_oxigem_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./entrega-oxigem.page */
      ...
      var EntregaOxigemPageRoutingModule = function EntregaOxigemPageRoutingModule() {
        _classCallCheck(this, EntregaOxigemPageRoutingModule);
      };

      EntregaOxigemPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPaginasInternasEntregaOxigemEntregaOxigemModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EntregaOxigemPageModule", function () {
        return EntregaOxigemPageModule;
      });
      /* harmony import */
      ...
      var _entrega_oxigem_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./entrega-oxigem-routing.module */
      "./src/app/paginasInternas/entrega-oxigem/entrega-oxigem-routing.module.ts");
      /* harmony import */


      var _entrega_oxigem_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./entrega-oxigem.page */
      "./src/app/paginasInternas/entrega-oxigem/entrega-oxigem.page.ts");
      /* harmony import */
      ...
      var EntregaOxigemPageModule = function EntregaOxigemPageModule() {
        _classCallCheck(this, EntregaOxigemPageModule);
      };

      EntregaOxigemPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _entrega_oxigem_routing_module__WEBPACK_IMPORTED_MODULE_5__["EntregaOxigemPageRoutingModule"], src_app_shareds_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
    ...
    /***/
    function srcAppPaginasInternasEntregaOxigemEntregaOxigemPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPaginasInternasEntregaOxigemEntregaOxigemPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EntregaOxigemPage", function () {
        return EntregaOxigemPage;
      });
      /* harmony import */
      ...
      var src_app_service_base_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/service/base.service */
      "./src/app/service/base.service.ts");
      /* harmony import */


      var src_app_service_datos_equipos_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/service/datos-equipos.service */
      "./src/app/service/datos-equipos.service.ts");
      /* harmony import */


      var src_app_service_sweetalert_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var src_app_service_datos_servicio_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/service/datos-servicio.service */
      "./src/app/service/datos-servicio.service.ts");

      var EntregaOxigemPage = /*#__PURE__*/function () {
        function EntregaOxigemPage(DatosServicioService, AuthService, formBuilder, DatosEquiposService, Router, BaseService, Sweetalert, ActivatedRoute) {
          _classCallCheck(this, EntregaOxigemPage);
          ...
          this.validation_messages = {
            ...
            'personaCelular': [{
              type: 'required',
              message: 'Celular es requerida.'
            }],
            'personaCorreoElectronico': [{
              type: 'required',
              message: 'Correo es requerida.'
            }]
          };
        }

        _createClass(EntregaOxigemPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            if (this.equipos.length) {
              if (this.equipos[0].otrosPendientes) {
                this.equipos[0].otrosPendientes.forEach(function (equipo) {
                  _this.equipos.push(equipo);
                });
              }
            ...
            _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"].Geolocation.getCurrentPosition().then(function (result) {
              console.log(result);
              _this.coordenadas.lat = result.coords.latitude;
              _this.coordenadas.lng = result.coords.longitude;
            });
            /* this.takePicture(); */


            this.form_persona_entrega.get("personaIdentificacion").valueChanges.subscribe(function (x) {
              _this.registrarPersona = false;
              _this.formularioCompleto = false;
            });
          }
        }, {
          key: "irRuta",
          ...
          key: "buscarPersona",
          value: function buscarPersona(value) {
            var _this2 = this;

            this.registrarPersona = false;
            this.formularioCompleto = false;
            var loading = this.BaseService.presentLoading();
            this.BaseService.postJson('personas', 'directorio', "validarExistenciaPersonaApi", value).subscribe(function (res) {
              console.log(res);

              if (res.RESPUESTA == "EXITO") {
                _this2.formularioCompleto = true;
                _this2.registrarPersona = true;
                _this2.personaId = res.DATOS.personaId;

                _this2.form_registrar_persona_entrega.controls['personaNombres'].setValue(res.DATOS.personaNombres);

                _this2.form_registrar_persona_entrega.controls['personaApellidos'].setValue(res.DATOS.personaApellidos);

                _this2.form_registrar_persona_entrega.controls['personaCelular'].setValue(res.DATOS.personaCelular);

                _this2.form_registrar_persona_entrega.controls['personaCorreoElectronico'].setValue(res.DATOS.personaCorreoElectronico);
              } else if (res.RESPUESTA == "INFO") {
                _this2.formularioCompleto = true;
                _this2.registrarPersona = true;
                _this2.personaId = "";

                _this2.form_registrar_persona_entrega.controls['personaNombres'].setValue("");

                _this2.form_registrar_persona_entrega.controls['personaApellidos'].setValue("");

                _this2.form_registrar_persona_entrega.controls['personaCelular'].setValue("");

                _this2.form_registrar_persona_entrega.controls['personaCorreoElectronico'].setValue("");
              } else {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"].Camera.getPhoto({
                        quality: 90,
                        allowEditing: true,
          ...
          key: "entregar",
          value: function entregar() {
            var _this3 = this;

            if (this.permisosFirma && this.firmaBase64 && this.equipos.length > 0) {
              var persona = Object.assign(this.form_registrar_persona_entrega.value, this.form_persona_entrega.value);
              persona.personaId = this.personaId;
              var reciboID = this.equipos[0].reciboId;
              var equiposID = this.equipos.map(function (res) {
                return {
                  equipoID: res.equipoId,
                  clienteID: res.clienteId,
                  clientePersona: res.clientePersona,
                  estadoEntregaEquipo: res.estadoEntregaEquipo,
                  reciboReferencia: res.reciboReferencia
                };
              });
              var datos = {
                reciboID: reciboID,
              ...
              console.log(datos);
              var loading = this.BaseService.presentLoading();
              this.BaseService.postJson('repartidores', 'entregarEquipos', "registrarEntregaEquiposPorRecibo", datos).subscribe(function (res) {
                console.log(res);

                if (res.RESPUESTA = "EXITO") {
                  _this3.DatosEquiposService.deleteEquipos();

                  _this3.Sweetalert.notificacion("success", "Recolección exitosa");

                  _this3.DatosServicioService.setRecibosServico(res.DATOS);

                  _this3.Router.navigateByUrl("recibos-servicios");
                } else {
          ...
          key: "firmaBase64Event",
          value: function firmaBase64Event($event) {
            this.firmaBase64 = $event;
          }
        }, {
          key: "permisoFirma",
          value: function permisoFirma() {
      ...
      EntregaOxigemPage.ctorParameters = function () {
        return [{
      ...
      EntregaOxigemPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-entrega-oxigem',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./entrega-oxigem.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/paginasInternas/entrega-oxigem/entrega-oxigem.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./entrega-oxigem.page.scss */
        "./src/app/paginasInternas/entrega-oxigem/entrega-oxigem.page.scss"))["default"]]
      })], EntregaOxigemPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=paginasInternas-entrega-oxigem-entrega-oxigem-module-es5.js.map